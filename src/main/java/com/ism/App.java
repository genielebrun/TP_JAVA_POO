                           ...
                           case 1://Modification categorie
                               do {
                                   ...
                                   if (categorieServiceImpl.show(idCatMod) != null){
                                       ...
                                       //repository.update(categorieMod);
                           ...
                           case 2://Modification Article Confection
                               ...
                               do {
                                   ...
                                   if (articleConfectionServiceImpl.show(idArtMod) != null){
                                       ...
                                       articleConfectionServiceImpl.update(articleMod);
                                       System.out.println("\n##### LISTE DE CATEGORIES A CHOISR POUR LA MODIFICATION #####");
                                       categorieServiceImpl.getAll().forEach(System.out::println);
                                       System.out.println("########################################################");
                                       System.out.println("Choisir la nouvelle categorie (via ID) :");
                                       idNewCat = scanner.nextInt();
                                       if (categorieServiceImpl.show(idNewCat) != null) {
                                           ArticleConfection articleConfection = new ArticleConfection();
                                           articleConfection.setCategorie(categorieServiceImpl.show(idNewCat));
                                           System.out.println("Modification effectuée avec succès !!!");
                                           break;
                                       } else {
                                           System.out.println("Index Introuvable !!");
                               ...
                               }while (idArtMod != repositoryArticleConfection.indexOf(idArtMod));
                               break;
                           default:
                               break;
                       }
